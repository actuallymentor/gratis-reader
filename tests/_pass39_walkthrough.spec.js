...
test.describe( `Pass 39 — Multi-step state transitions`, () => {
    ...
    test.describe( `Seeded reader state transitions`, () => {
    ...
    test.describe( `Fresh deletion lifecycle`, () => {
    ...
    test.describe( `Seeded progress state`, () => {
    ...
    test.describe( `Fresh full lifecycle`, () => {
    ...
    test.describe( `Seeded reader interactions`, () => {
